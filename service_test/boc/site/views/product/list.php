	...
	<div class="pd-20">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20"> 
			<span class="l">
				...
				<a class="btn btn-primary radius" onclick="product_add('添加产品','<?php echo site_url('product/product_add');?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加产品</a>
			</span> 
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody>
					<tr class="text-c va-m">
						...
						<td class="text-l">
							<a style="text-decoration:none" onClick="product_show('哥本哈根橡木地板','product-show.html','10001')" href="javascript:;"><img title="国内品牌" src="<?php echo static_file('img/cn.gif')?>"> <b class="text-success">圣象</b> 哥本哈根橡木地板KS8373</a>
						</td>
						...
						<td class="td-manage">
							...
							<a style="text-decoration:none" class="ml-5" onClick="product_edit('产品编辑','<?php echo site_url('product/product_add');?>','10001')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> 
...
<?php
	...
	echo static_file('lib/zTree/v3/js/jquery.ztree.all-3.5.min.js');
?>
