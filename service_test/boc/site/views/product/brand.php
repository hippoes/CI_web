...
<nav class="breadcrumb">
	<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 产品管理 <span class="c-gray en">&gt;</span> 品牌管理 
		...
		<table class="table table-border table-bordered table-bg table-sort">
			...
			<tbody>
				<tr class="text-c">
					...
					<td><img src="<?php echo static_file('img/dongpeng.jpeg'); ?>"></td>
...
<?php
	...
	echo static_file('js/H-ui.admin.product.js');
?>
