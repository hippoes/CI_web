...
<head>
	...
	<?php
		...
		echo static_file('lib/webuploader/0.1.5/webuploader.css');
	?>
</head>
<body>
<div class="pd-20">
...
<?php
	...
	echo static_file('lib/webuploader/0.1.5/webuploader.min.js');
	echo static_file('lib/ueditor/1.4.3/ueditor.config.js');
	echo static_file('lib/ueditor/1.4.3/ueditor.all.min.js');
	echo static_file('lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js');
?>
