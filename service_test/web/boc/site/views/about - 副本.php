		    		...
		    		<?php foreach ($recruit_list as $v): ?>
			    		<li>
			    			...
			    			<div class="con">
			    				...
			    				<a href="mailto:2441561897@qq.com?subject=test&cc=3352395928@qq.com&body=use mailto 2441561897@qq.com" target="_blank">发送简历至：<?php if (!empty($recruit_email['title'])) echo $recruit_email['title'] ?></a>
			    			</div>
			    		</li>
			    	<?php endforeach; ?>
		    	</ul>
