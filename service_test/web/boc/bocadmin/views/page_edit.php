<?php
$cid=$this->cid;
$need_title=array(31,34,41,49,65,71,74,77,80,86,89);
$need_photo=array(21,22,31,33,34,49,61,65,86,89);
$need_outline=array(29,31,34,41,49,65,68,84,86,89);
$need_photo1=array();
$need_icon1=array(21,22);
$need_icon2=array();
$need_icon3=array();
$need_field1=array(65,68);
$need_field2=array();
$need_field3=array();
$no_content=array(31,34,49,65,89);
...
if ($cid==34||$cid==89){
    ...
    $field1_name='移动端美妍介绍';
    $outline_name='四位一体后简介';
}elseif($cid==80){
    $outline_name='四大问题后简介';
}elseif($cid==84){
    $outline_name='移动端运动简介';
}elseif($cid==86){
    $outline_name='职称';
}elseif($cid==69){
	$field1_name='所在城市';
...
<h3>  <i class="fa fa-pencil"></i> <?php //echo current_urlc(); ?> <?php echo $title; ?></h3>
