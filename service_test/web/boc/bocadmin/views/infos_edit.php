<?php
$cid=$this->cid;
$need_photo=array(24,25,26,27,32,35,36,37,38,44,46,53,59,72,75,78,85,91);
$need_photo1=array();
$need_content=array(24,25,26,27,32,35,36,37,38,48,54,59,62,81);
$need_outline=array(24,25,37,38,44,46,53,54,60,64,72,75,78,85,91);
$need_icon=array(53,64);
$need_icon_no_thumb=array(36,44);
$need_field1=array(27,32,59,90);
$need_field2=array();
$need_field3=array();
$need_field4=array();
$need_field5=array();
...
$need_icon1=array();
$need_icon2=array();
$need_pics=array(26,27,54,62,81);
$need_title1=array();
$outline_names = array(26,31,60,72,75,78,85);
...
$pics_name='图集';
$title1_name='标题1';
if (in_array($cid,$outline_names)){
    $outline_name='文本(列表)';
    $outline_placeholder='若要以列表形式展现，请用“##”隔离字符，如：##你好##大家好';
}elseif($cid==24 || $cid==25 || $cid==37 || $cid==38){
    $outline_name='职称';
    $outline_placeholder='若要以列表形式展现，请用“##”隔离字符，如：##你好##大家好';
}elseif($cid==45){
    $photo1_name='首页图片';
...
<!--				<a href="#seo-modal" role="button" class="btn btn-info" data-toggle="modal">SEO</a>-->
        ...
        <?php if (in_array($cid,$need_field1)): ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" <?php if($cid==52||$cid==59) echo "placeholder='类似 http://... 或 https://...'" ?> class='span7' id="field1" name="field1" value="<?php echo set_value("field1",$it['field1']) ?>">
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if (in_array($cid,$need_pics)): ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
					...
					<span class="btn btn-success">
						<i class="fa fa-upload"></i>
						<span> <?php echo lang('upload_file') ?> </span>[<?php echo $pics_px[$cid] ?>]<?php if($cid==26 || $cid==27) echo "前台取前3张"; else if($cid==62) echo " 前台取4张"; else if($cid==81) echo " 前台最多取3张";?>
