...
$outline_names = array(26,31,46,53,60,72,75,78,85);
$photo_px=array(
    24 => '216x319',
    25 => '216x319',
    26 => '540x380',
...
<!--				<a href="#seo-modal" role="button" class="btn btn-info" data-toggle="modal">--><?php //echo lang('seo') ?><!--</a>-->
        ...
        <?php if (in_array($cid,$need_field1)): ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" <?php if($cid==52||$cid==59) echo "placeholder='类似 http://... 或 https://...'" ?> class='span7' id="field1" name="field1" value="<?php echo set_value("field1") ?>">
                </div>
            </div>
        <?php endif; ?>
